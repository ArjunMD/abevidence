...
def assessment_and_plan(hpi: str, considerations: str = "") -> dict:
    ...
    instructions = (
        ...
        "   * 'lead': the opening narrative line of the plan — for problem 1 ONLY. Every "
        "later problem must have an empty 'lead': do not describe, justify, or attribute "
        "the problem, and do not open with 'Due to ...' — the diagnosis name is the whole "
        "description, and only actions follow it.\n"
        ...
        "Positive findings only — do NOT recite pertinent negatives or absent symptoms "
        "('without orthopnea', 'no leg swelling', 'denies fever'). One to three sentences, "
        "no plan content (e.g. 'Patient presented with three days of fever, productive "
        "cough, and pleuritic chest pain. Febrile, tachypneic, and hypoxic on arrival, with "
        "rales at the right base, leukocytosis, and a RLL infiltrate on CXR.').\n"
